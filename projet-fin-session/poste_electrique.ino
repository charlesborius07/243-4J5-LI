// Poste electrique de transformation urbain - LilyGO WiFi MQTT
// Monitoring: BME280 (climat), EKMC (intrusion), pots (tension/courant)
// LEDs: etat reseau + alarme
...
void publishTelemetry() {
  ...
  Serial.print("[MQTT] -> Tension: ");
  Serial.println(payloadTension);
